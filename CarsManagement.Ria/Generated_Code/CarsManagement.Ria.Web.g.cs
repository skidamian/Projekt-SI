...
namespace CarsManagement.Ria.Web
{
    ...
    public sealed partial class DomainService1 : DomainContext
    {
        ...
        /// <summary>
        /// Gets the set of <see cref="produkty"/> entities that have been loaded into this <see cref="DomainService1"/> instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets an EntityQuery instance that can be used to load <see cref="produkty"/> entities using the 'GetProdukties' query.
        /// </summary>
        /// <returns>An EntityQuery that can be loaded to retrieve <see cref="produkty"/> entities.</returns>
