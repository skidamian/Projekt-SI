...
namespace PaymentManagement.ViewModel
{
    public class NavigateViewModel : ViewModelBase
    {
        private static Uri MainView = new Uri("PaymentManagementMainView", UriKind.Relative);
        IRegionManager regionManager;
        IUnityContainer container;

        public NavigateViewModel(IRegionManager regionManager, IUnityContainer container)
        {
